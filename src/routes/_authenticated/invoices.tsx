  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-4 flex flex-col sm:flex-row gap-3">
        <SearchInput placeholder="Rechercher une facture..." value={search} onChange={setSearch} />
                  ...
                  <tr key={inv._id} className="hover:bg-muted/30">
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center justify-end gap-1">
                        <Link to="/invoices/$id" params={{ id: inv._id }} className="p-1.5 rounded-lg hover:bg-muted text-muted-foreground"><Eye className="w-4 h-4" /></Link>
